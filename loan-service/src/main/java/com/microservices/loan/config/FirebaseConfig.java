package com.microservices.loan.config;
...
/**
 * Firebase Configuration for Loan Service
 * 
 * Initializes Firebase Admin SDK for database operations.
 */
@Configuration
@Slf4j
public class FirebaseConfig {
    ...
    public FirebaseApp firebaseApp() throws IOException {
        log.info("Initializing Firebase Admin SDK for Loan Service");
